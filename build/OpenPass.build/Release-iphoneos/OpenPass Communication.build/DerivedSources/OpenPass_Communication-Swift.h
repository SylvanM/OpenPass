...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OpenPass_Communication",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22OpenPass_Communication22MessagesViewController")
...
@interface MessagesViewController (SWIFT_EXTENSION(OpenPass_Communication)) <UICollectionViewDataSource, UICollectionViewDelegate>

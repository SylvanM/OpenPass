...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OpenPass",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8OpenPass21AccountViewController")
@interface AccountViewController : UITableViewController <UITextViewDelegate>
...
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified otherInfoField;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified shouldHaveSecureTextEntrySwitch;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (IBAction)usernameEditingDidEnd:(id _Nonnull)sender;
- (IBAction)passwordEditingDidEnd:(id _Nonnull)sender;
- (IBAction)emailEditingDidEnd:(id _Nonnull)sender;
- (IBAction)usernamePrimaryActionTriggered:(id _Nonnull)sender;
- (IBAction)passwordPrimaryActionTriggered:(id _Nonnull)sender;
- (IBAction)emailPrimaryActionTriggered:(id _Nonnull)sender;
...
- (void)editName;
- (IBAction)userToggledSecureTextEntry:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC8OpenPass28AuthenticationViewController")
@interface AuthenticationViewController : UIViewController
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (IBAction)userWantsToAuthenticate:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC8OpenPass16LimitedTextField")
...
SWIFT_CLASS("_TtC8OpenPass12PasswordCell")
...
SWIFT_CLASS("_TtC8OpenPass23PasswordsViewController")
@interface PasswordsViewController : UITableViewController
- (void)viewDidLoad;
- (void)appReopened;
- (void)viewWillAppear:(BOOL)animated;
- (IBAction)addPassword:(id _Nonnull)sender;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
...
@interface PasswordsViewController (SWIFT_EXTENSION(OpenPass)) <UISearchResultsUpdating>
...
SWIFT_CLASS("_TtC8OpenPass17RootNavController")
...
SWIFT_CLASS("_TtC8OpenPass22SettingsViewController")
@interface SettingsViewController : UITableViewController <UIPickerViewDataSource, UIPickerViewDelegate>
@property (nonatomic, weak) IBOutlet LimitedTextField * _Null_unspecified sortingPicker;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewDidLoad;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
